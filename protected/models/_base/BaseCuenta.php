 ...
 */
class BaseCuenta extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idCuenta, idCliente, estado, saldo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'matriculas' => array(self::HAS_MANY, 'Matricula', 'idCuenta'),
			'recibos' => array(self::HAS_MANY, 'Recibo', 'idCuenta'),
		);
	}
